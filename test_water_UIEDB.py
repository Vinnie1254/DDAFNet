...
if __name__ == '__main__':
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='/home/gxy/PycharmProjects/Model_main_water/results/OURNet_water/model_1000.pkl')
    parser.add_argument('--save_image', type=bool, default=True, choices=[True, False])
    parser.add_argument('--result_txt', type=str, default='/home/gxy/PycharmProjects/Model_main_water/results/OURNet_water/UIEDB_results_2025_10_20.txt')

    args = parser.parse_args()
    args.model_save_dir = os.path.join('results/', args.model_name, 'weights/')
    args.result_dir = os.path.join('results/', args.model_name, '/home/gxy/PycharmProjects/Model_main_water/results/OURNet_water/UIEDB_test_visual_1020')
    print(args)
    main(args)
