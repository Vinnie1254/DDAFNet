...
if __name__ == '__main__':
    ...
    args.model_save_dir = os.path.join('results/', args.model_name, 'LSUI_weights_1020/')
    args.result_dir = os.path.join('results/', args.model_name, 'LSUI_visual_1020/')
    print(args)
    main(args)
...
--data_dir /home/gxy/PycharmProjects/Model_main_water/datasets/LSUI \
--batch_size 1 \
--learning_rate 1e-4 \
--num_epoch 1000 \
--resume results/OURNet_water/LSUI_weights_1020/model_100.pkl
'''
